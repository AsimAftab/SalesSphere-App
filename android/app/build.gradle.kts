...
android {
    ...
    defaultConfig {
        ...
        applicationId = "com.salessphere"
        // You can update the following values to match your application needs.
        // For utilities information, see: https://flutter.dev/to/review-gradle-config.
    ...
    signingConfigs {
        create("release") {
            ...
            storeFile = rootProject.file(keystoreProperties.getProperty("storeFile") ?: "salessphere-upload-key.jks")
