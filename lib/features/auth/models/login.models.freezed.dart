...
mixin _$LoginResponse {
 ...
 String get status; String get token; LoginData get data;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LoginResponse&&(identical(other.status, status) || other.status == status)&&(identical(other.token, token) || other.token == token)&&(identical(other.data, data) || other.data == data));
}
...
@override
String toString() {
  return 'LoginResponse(status: $status, token: $token, data: $data)';
}
...
@useResult
$Res call({
 String status, String token, LoginData data
});
...
/// Create a copy of LoginResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? status = null,Object? token = null,Object? data = null,}) {
  return _then(_self.copyWith(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String status,  String token,  LoginData data)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LoginResponse() when $default != null:
return $default(_that.status,_that.token,_that.data);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String status,  String token,  LoginData data)  $default,) {final _that = this;
switch (_that) {
case _LoginResponse():
return $default(_that.status,_that.token,_that.data);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String status,  String token,  LoginData data)?  $default,) {final _that = this;
switch (_that) {
case _LoginResponse() when $default != null:
return $default(_that.status,_that.token,_that.data);case _:
  return null;
...
class _LoginResponse implements LoginResponse {
  const _LoginResponse({required this.status, required this.token, required this.data});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _LoginResponse&&(identical(other.status, status) || other.status == status)&&(identical(other.token, token) || other.token == token)&&(identical(other.data, data) || other.data == data));
}
...
/// Create a copy of LoginResponse
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? status = null,Object? token = null,Object? data = null,}) {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LoginData&&(identical(other.user, user) || other.user == user));
}
...
class _LoginData implements LoginData {
  const _LoginData({required this.user});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _LoginData&&(identical(other.user, user) || other.user == user));
}
...
@JsonKey(name: '_id') String get id; String get name; String get email; String get role; String get organizationId; bool get isActive; String get phone; String get address; String get gender; String get dateOfBirth; int get age; String get panNumber; String get citizenshipNumber; String get dateJoined; List<Document> get documents; String get createdAt; String get updatedAt;@JsonKey(name: '__v') int get version; String? get avatarUrl;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,email,role,organizationId,isActive,phone,address,gender,dateOfBirth,age,panNumber,citizenshipNumber,dateJoined,const DeepCollectionEquality().hash(documents),createdAt,updatedAt,version,avatarUrl]);

@override
String toString() {
  return 'User(id: $id, name: $name, email: $email, role: $role, organizationId: $organizationId, isActive: $isActive, phone: $phone, address: $address, gender: $gender, dateOfBirth: $dateOfBirth, age: $age, panNumber: $panNumber, citizenshipNumber: $citizenshipNumber, dateJoined: $dateJoined, documents: $documents, createdAt: $createdAt, updatedAt: $updatedAt, version: $version, avatarUrl: $avatarUrl)';
}
...
@useResult
$Res call({
@JsonKey(name: '_id') String id, String name, String email, String role, String organizationId, bool isActive, String phone, String address, String gender, String dateOfBirth, int age, String panNumber, String citizenshipNumber, String dateJoined, List<Document> documents, String createdAt, String updatedAt,@JsonKey(name: '__v') int version, String? avatarUrl
});
...
as List<Document>,createdAt: null == createdAt ? _self.createdAt : createdAt // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: '_id')  String id,  String name,  String email,  String role,  String organizationId,  bool isActive,  String phone,  String address,  String gender,  String dateOfBirth,  int age,  String panNumber,  String citizenshipNumber,  String dateJoined,  List<Document> documents,  String createdAt,  String updatedAt, @JsonKey(name: '__v')  int version,  String? avatarUrl)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _User() when $default != null:
return $default(_that.id,_that.name,_that.email,_that.role,_that.organizationId,_that.isActive,_that.phone,_that.address,_that.gender,_that.dateOfBirth,_that.age,_that.panNumber,_that.citizenshipNumber,_that.dateJoined,_that.documents,_that.createdAt,_that.updatedAt,_that.version,_that.avatarUrl);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: '_id')  String id,  String name,  String email,  String role,  String organizationId,  bool isActive,  String phone,  String address,  String gender,  String dateOfBirth,  int age,  String panNumber,  String citizenshipNumber,  String dateJoined,  List<Document> documents,  String createdAt,  String updatedAt, @JsonKey(name: '__v')  int version,  String? avatarUrl)  $default,) {final _that = this;
switch (_that) {
case _User():
return $default(_that.id,_that.name,_that.email,_that.role,_that.organizationId,_that.isActive,_that.phone,_that.address,_that.gender,_that.dateOfBirth,_that.age,_that.panNumber,_that.citizenshipNumber,_that.dateJoined,_that.documents,_that.createdAt,_that.updatedAt,_that.version,_that.avatarUrl);case _:
  throw StateError('Unexpected subclass');
...
class _User implements User {
  const _User({@JsonKey(name: '_id') required this.id, required this.name, required this.email, required this.role, required this.organizationId, required this.isActive, required this.phone, required this.address, required this.gender, required this.dateOfBirth, required this.age, required this.panNumber, required this.citizenshipNumber, required this.dateJoined, required final  List<Document> documents, required this.createdAt, required this.updatedAt, @JsonKey(name: '__v') required this.version, this.avatarUrl}): _documents = documents;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,email,role,organizationId,isActive,phone,address,gender,dateOfBirth,age,panNumber,citizenshipNumber,dateJoined,const DeepCollectionEquality().hash(_documents),createdAt,updatedAt,version,avatarUrl]);
...
@JsonKey(name: '_id') String get id; String get fileName; String get fileUrl; String get uploadedAt;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Document&&(identical(other.id, id) || other.id == id)&&(identical(other.fileName, fileName) || other.fileName == fileName)&&(identical(other.fileUrl, fileUrl) || other.fileUrl == fileUrl)&&(identical(other.uploadedAt, uploadedAt) || other.uploadedAt == uploadedAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,fileName,fileUrl,uploadedAt);

@override
String toString() {
  return 'Document(id: $id, fileName: $fileName, fileUrl: $fileUrl, uploadedAt: $uploadedAt)';
}
...
@useResult
$Res call({
@JsonKey(name: '_id') String id, String fileName, String fileUrl, String uploadedAt
});
...
/// Create a copy of Document
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? fileName = null,Object? fileUrl = null,Object? uploadedAt = null,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: '_id')  String id,  String fileName,  String fileUrl,  String uploadedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Document() when $default != null:
return $default(_that.id,_that.fileName,_that.fileUrl,_that.uploadedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: '_id')  String id,  String fileName,  String fileUrl,  String uploadedAt)  $default,) {final _that = this;
switch (_that) {
case _Document():
return $default(_that.id,_that.fileName,_that.fileUrl,_that.uploadedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: '_id')  String id,  String fileName,  String fileUrl,  String uploadedAt)?  $default,) {final _that = this;
switch (_that) {
case _Document() when $default != null:
return $default(_that.id,_that.fileName,_that.fileUrl,_that.uploadedAt);case _:
  return null;
...
class _Document implements Document {
  const _Document({@JsonKey(name: '_id') required this.id, required this.fileName, required this.fileUrl, required this.uploadedAt});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Document&&(identical(other.id, id) || other.id == id)&&(identical(other.fileName, fileName) || other.fileName == fileName)&&(identical(other.fileUrl, fileUrl) || other.fileUrl == fileUrl)&&(identical(other.uploadedAt, uploadedAt) || other.uploadedAt == uploadedAt));
}
...
/// Create a copy of Document
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? fileName = null,Object? fileUrl = null,Object? uploadedAt = null,}) {
