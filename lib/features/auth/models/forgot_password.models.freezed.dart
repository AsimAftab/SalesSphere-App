...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ForgotPasswordResponse&&(identical(other.status, status) || other.status == status)&&(identical(other.message, message) || other.message == message));
}
...
@override
String toString() {
  return 'ForgotPasswordResponse(status: $status, message: $message)';
}
...
class _ForgotPasswordResponse implements ForgotPasswordResponse {
  const _ForgotPasswordResponse({required this.status, required this.message});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ForgotPasswordResponse&&(identical(other.status, status) || other.status == status)&&(identical(other.message, message) || other.message == message));
}
