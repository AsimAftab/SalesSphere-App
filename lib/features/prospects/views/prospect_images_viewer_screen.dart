...
class ProspectImagesViewerScreen extends ConsumerStatefulWidget {
  final String prospectId;
  final int initialIndex;
  final List<ProspectImage> images;

  const ProspectImagesViewerScreen({
    super.key,
  ...
  @override
  ConsumerState<ProspectImagesViewerScreen> createState() =>
      _ProspectImagesViewerScreenState();
}

class _ProspectImagesViewerScreenState
    extends ConsumerState<ProspectImagesViewerScreen> {
