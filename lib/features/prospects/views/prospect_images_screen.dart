...
class _ProspectImagesScreenState extends ConsumerState<ProspectImagesScreen> {
    ...
    try {
      ...
      for (int i = 0; i < imageFiles.length; i++) {
        ...
        try {
          ...
          // Find the next available image number (1-5)
          ...
          final response = await dio.post(
            ApiEndpoints.uploadProspectImage(widget.prospectId),
            data: formData,
          );
  ...
  Future<void> _confirmDelete(ProspectImage image) async {
    ...
    return GestureDetector(
      onTap: () {
        ...
        Navigator.of(context).push(
          MaterialPageRoute(
            builder: (context) => ProspectImagesViewerScreen(
              prospectId: widget.prospectId,
              initialIndex: index,
              images: allImages,
            ),
                ...
                return Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Description
                      Text(
                        'Add up to 5 photos for this prospect',
                        style: TextStyle(
                          fontSize: 14.sp,
                          color: Colors.grey.shade600,
                          fontFamily: 'Poppins',
