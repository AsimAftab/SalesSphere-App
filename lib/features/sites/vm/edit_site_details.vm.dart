// lib/features/sites/vm/edit_site_details.vm.dart
...
Future<void> updateSite(WidgetRef ref, SiteDetails updatedSiteDetails) async {
  try {
    ...
    final currentSites = await ref.read(siteViewModelProvider.future);
    ...
    ref.read(siteViewModelProvider.notifier).state =
